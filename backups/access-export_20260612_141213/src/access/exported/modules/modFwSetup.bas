...
Private Sub InsertShellTranslations(ByVal db As DAO.Database)
    ...
    EnsureTranslationSeed db, "FR-FR", "FORM.FRMFWTRANSLATIONEDIT.SOURCE_LANGUAGE", "Langue source", "FORM", 270
    ...
    EnsureTranslationSeed db, "FR-FR", "MSG.TRANSLATION_EDIT_DEEPL_SOURCE_REQUIRED", "Veuillez d'abord saisir un texte dans la langue source.", "MSG", 276
