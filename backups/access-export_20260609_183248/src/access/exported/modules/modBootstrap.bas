...
Public Function BootstrapApplication(Optional ByVal IniPath As String = vbNullString) As Boolean
    ...
    If Not modFwSetup.EnsureOrderSchema() Then
        Err.Raise vbObjectError + 2201, MODULE_NAME & ".BootstrapApplication", "Order schema initialization failed."
    End If
    modLoggingHandler.LogInfo MODULE_NAME & ".BootstrapApplication", "Order schema initialized."
